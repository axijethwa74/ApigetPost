...
class Data {
  Data({
    ...
    _colors = colors;
    _size = size;
    _images = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZdLNkNr4isTCbuXHpNoDDd2mb_7436P-h1TsPenM&s" as List<Images>?;
    _v = v;
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['images'] != null) {
      _images = [];
      json['"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZdLNkNr4isTCbuXHpNoDDd2mb_7436P-h1TsPenM&s" as List<Images>?;'].forEach((v) {
